...
#Had to install a forked repo of googletrans "https://github.com/BoseCorp/py-googletrans.git" and apply a fix to gtoken.py found here "https://github.com/ssut/py-googletrans/issues/93"
#Due to google changing their API and breaking the module
...
TOKEN = "NTA1MTA0NjI2OTUwMDc4NDc1.DrOvlQ.N7v25yqqXv3IcsXzejPnD0hY-GU"
